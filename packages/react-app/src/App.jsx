...
const kolektibel = [
  {
    id: "1",
    current_owner: "0xslkwesdlj",
    name: "Dompet",
    description: "Bagus",
    image_url:
      "https://cdn.shopify.com/s/files/1/2563/8374/products/335EB808-98FA-4474-8E54-E82825F6818B_1640x.jpg?v=1634335514",
  },
  {
    id: "2",
    current_owner: "0xslkfjjflj",
    name: "Sepatu",
    description: "Kinclong",
    image_url:
      "https://i0.wp.com/shoegazing.com/wp-content/uploads/2022/04/DSC02002-scaled.jpg?resize=1140%2C700&ssl=1&is-pending-load=1",
  },
];
...
function ProductHistoryModel(x) {
  return {
    ...
    customers: x.customers.length === 0 ? undefined : x.customers.map(c => UserHistoryModel(c, "Customer")),
...
const sepoliaInfura = navigator.onLine
  ? new ethers.providers.StaticJsonRpcProvider("https://sepolia.infura.io/v3/" + INFURA_ID)
  : null;
          ...
          <Route path="/ipfsup">
            ...
            <Button
              ...
              onClick={async () => {
                ...
                setSending(true);
                setIpfsHash();
                const result = await ipfs.instance.add(JSON.stringify(yourJSON)); // addToIPFS(JSON.stringify(yourJSON))
          ...
          <Route path="/ipfsdown">
            ...
            <Button
              ...
              onClick={async () => {
                ...
                setDownloading(true);
                setIpfsContent();
                const result = await ipfs.getFileFromHash(ipfsDownHash); // addToIPFS(JSON.stringify(yourJSON))
