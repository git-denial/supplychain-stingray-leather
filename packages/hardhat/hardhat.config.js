  ...
  networks: {
    ...
    sepolia: {
      ...
      accounts: [
        ...
        `0x${process.env.WALLET_PRIVATE_KEY_2}`,
        `0x${process.env.WALLET_PRIVATE_KEY_3}`,
        `0x${process.env.WALLET_PRIVATE_KEY_4}`,
        `0x${process.env.WALLET_PRIVATE_KEY_5}`,
        `0x${process.env.WALLET_PRIVATE_KEY_6}`,
        `0x${process.env.WALLET_PRIVATE_KEY_7}`,
        `0x${process.env.WALLET_PRIVATE_KEY_8}`,
        `0x${process.env.WALLET_PRIVATE_KEY_9}`,
        `0x${process.env.WALLET_PRIVATE_KEY_10}`,
      ],
      gas: 2100000,
      gasPrice: 1000000000,
      gasReporter: {
